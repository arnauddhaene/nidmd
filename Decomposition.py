...
class Decomposition:
    def __init__(self, filenames, howManyModes=5):
        ...
        # Fetch surface mesh
        self.fsaverage = datasets.fetch_surf_fsaverage('fsaverage', 'res')
    ...
    def readGlobalVariables(self):
        ...
        """
        with open('res/globalvariables.JSON') as json_file:
    ...
    def clearBin(self):
        ...
        for filename in os.listdir('bin'):
            ...
            # TODO: find a way to handle errors in the toolbox
    ...
    def createModeDirs(self, howMany):
        ...
        modes = ['bin/mode-%s' % mode for mode in range(howMany)]
